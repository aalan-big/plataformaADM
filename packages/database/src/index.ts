...
export * from './repositories/licenca-sessao.repository'
...
export * from './repositories/parceiro.repository'
export * from './repositories/transacao.repository'
export * from './repositories/cobranca-renovacao.repository'
export * from './repositories/inscricao-push.repository'
export * from './repositories/fiscal.repository'
export * from './repositories/modulo.repository'
